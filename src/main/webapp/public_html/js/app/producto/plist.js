...
moduleProducto.controller('productoPlistController', ['$scope', '$http', '$location', 'toolService', '$routeParams', 'sessionService',
    function ($scope, $http, $location, toolService, $routeParams, sessionService) {
        ...
        $http({
            method: 'GET',
            url: host+'json?ob=producto&op=getcount&ejercicio=' + sessionService.getEmpresa()
        ...
        $http({
            method: 'GET',
            url: host+'json?ob=producto&op=getpage&ejercicio=' + sessionService.getEmpresa() + '&rpp=' + $scope.rpp + '&page=' + $scope.page + $scope.orderURLServidor
        }).then(function (response) {
            $scope.status = response.status;
