...
moduleCliente.controller('clientePlistController', ['$scope', '$http', '$location', 'toolService', '$routeParams', 'sessionService',
    function ($scope, $http, $location, toolService, $routeParams, sessionService) {
        ...
        $http({
            method: 'GET',
            url: host + 'json?ob=cliente&op=getcount&ejercicio=' + sessionService.getEmpresa()
        ...
        $http({
            method: 'GET',
            url: host + 'json?ob=cliente&op=getpage&ejercicio=' + sessionService.getEmpresa() + '&rpp=' + $scope.rpp + '&page=' + $scope.page + $scope.orderURLServidor
        }).then(function (response) {
            $scope.status = response.status;
